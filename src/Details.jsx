    ...
    <div>
      ...
      <div className="flex h-auto w-auto">
        <div className="description-container flex flex-col justify-center items-center text-white bg-neutral-700 p-1.5 w-4/5 h-auto my-20 mx-auto rounded-lg">
          ...
          <div className="pokedex-data-container flex align-top">
            ...
            <table className="basic-data table-auto w-2/3 border-collapse mx-5">
              <thead>
                <tr>
            ...
            <table className="training-data table-auto w-2/3 border-collapse border-gray-300">
              <thead>
                <tr>
          ...
          <div className="stats-container flex flex-col justify-start items-center my-10">
            <h2 className="text-xl font-bold">Stats</h2>
            <ul>
              {pokemonData.stats?.map((stat) => {
                return (
                  <li key={stat.stat.name}>
                    <span className="font-bold text-transform: capitalize">
                      {stat.stat.name}
                    </span>
                    : {stat.base_stat}
                  </li>
          ...
          <div className="moves-container flex w-4/5">
            <div className="level-up flex-col w-2/3">
              <h2 className="text-xl font-bold text-center">Level-up Moves</h2>
              <table className="moves-table table-auto  border-collapse border-gray-300 my-4 m-auto">
                <thead>
                  <tr>
                ...
                <tbody>
                  {pokemonData.moves
                    ...
                    .map((move) => (
                      <tr className="border-t border-b" key={move.move.name}>
                        <td className="px-4 py-1 text-center">
                          {move.version_group_details[0].level_learned_at}
                        </td>
                        <td className="px-4 py-1 text-center text-transform: capitalize">
                          {move.move.name}
                        </td>
                      </tr>
                    ))}
            ...
            <div className="machine-moves-container flex-col w-2/3">
              <h2 className="text-xl font-bold text-center">Machine Moves</h2>
              <table className="machine-moves-table table-auto w-2/3 border-collapse border-gray-300 my-4 m-auto">
                <thead>
                  <tr>
                    <th className="px-4 py-1 text-center">Move</th>
                  </tr>
            ...
            <div className="tutor-moves-container flex-col w-2/3">
              <h2 className="text-xl font-bold text-center">Egg Moves</h2>
              <table className="egg-moves-table table-auto w-2/3 border-collapse border-gray-300 my-4 m-auto">
                <thead>
                  <tr>
                    <th className="px-4 py-1 text-center">Move</th>
                  </tr>
            ...
            <div className="tutor-moves-container flex-col w-2/3">
              <h2 className="text-xl font-bold m-auto text-center">
                Tutor Moves
              </h2>
              <table className="tutor-moves-table table-auto w-2/3 border-collapse border-gray-300 my-4 m-auto">
                <thead>
                  <tr>
